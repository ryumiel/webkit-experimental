...
void MediaPlayerPrivateGStreamerBase::updateTexture(BitmapTextureGL& texture, GraphicsContext3D& context3D, GstVideoInfo& videoInfo)
{
...
void MediaPlayerPrivateGStreamerBase::pushTextureToCompositor()
{
    ...
    */
    ...
    if (UNLIKELY(!m_context3D))
        m_context3D = GraphicsContext3D::create(GraphicsContext3DAttributes(), nullptr, GraphicsContext3D::RenderOffscreen);

    updateTexture(buffer->textureGL(), *m_context3D, videoInfo);
...
void MediaPlayerPrivateGStreamerBase::paintToTextureMapper(TextureMapper& textureMapper, const FloatRect& targetRect, const TransformationMatrix& matrix, float opacity)
{
    ...
    if (m_usingFallbackVideoSink) {
        ...
        TextureMapperGL::Flags flags;
        {
            ...
            updateTexture(static_cast<BitmapTextureGL&>(*texture), *reinterpret_cast<TextureMapperGL&>(textureMapper).graphicsContext3D(), videoInfo);
        }
